-- Add admin flag for local MVP admin access.
...
CREATE TABLE "RecommendedProduct" (
  ...
  CONSTRAINT "RecommendedProduct_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
